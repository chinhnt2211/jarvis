...
<head><title>Học phần của bạn</title>
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-400.7f3badcdcf2aadb.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-400.0e0d6172d8923f8.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-600.58e7761738b2022.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-600.5fc563260c39eea.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-600.9c15c1f83df97ea.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-700.97a80bb0229b9a8.woff2')}}"
          rel="preload" type="font/woff2">
    <link as="font" crossorigin="anonymous"
          href="{{asset('fonts/hurmegeosans-no2-700.42f8ecee380b6fd.woff2')}}"
          rel="preload" type="font/woff2">
    <link rel="stylesheet" type="text/css" href="{{asset('css/global.55229ffeecece22.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/common.9dc077158bc442d.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/dashboard.e54936b8b2424b9.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('css/logged_in_homepage.fdf4ed0ef17a7f8.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/ui.68e6536514469f6.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('css/header_and_common.7485b8ffb8621f5.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('css/quizlet_global.1dd73c351bbed6e.css')}}">
    <meta property="og:site_name" content="Quizlet">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0">
    <meta name="yandex-verification" content="4a4a4256f578aafa">
    <meta name="referrer" content="strict-origin-when-cross-origin">
    <meta name="color-scheme" content="light dark">
    <meta name="description"
          content="Quizlet có các công cụ học để giúp bạn tìm hiểu bất cứ nội dung gì. Cải thiện điểm số và đạt mục tiêu của bạn với thẻ ghi nhớ, bài kiểm tra thử và các lời giải được chuyên gia biên soạn, ngay hôm nay.">
    <meta name="apple-itunes-app" content="none">
    <script src="https://kit.fontawesome.com/fa4609cc2c.js" crossorigin="anonymous"></script>
    <style>
        .c1ap9d88:hover{
            --c1ap9d88-7:var(--gray-200-gray-800);
        }
    </style>
</head>
<body class="study_feed latest_activity has-no-footer has-sticky-header qad-is-showing flex-sidebar theme-night"
      itemscope itemtype="{{asset('http://schema.org/WebPage')}}">
<div class="site">
    <div class="TopNavigationWrapper" id="TopNavigationReactTarget">
        <header class="TopNavigation" itemscope="" itemtype="{{asset('http://schema.org/WPHeader')}}" role="banner">
            <div class="TopNavigation-content">
                <div class="TopNavigation-contentLeft">
                    <div class="TopNavigationItem LogoNavigationItem">
                        <div class="SiteHeaderLogo">
                            <div class="SiteHeaderLogo-full">
                                <a class="SiteHeaderLogo-link" data-testid="logo-button"
                                   href="/">
                                    <div aria-label="Quizlet" class="SiteLogo" role="img" title="Quizlet">
                                        <svg data-testid="FullLogo" fill="currentColor" viewBox="0 0 86 20"
                                            ...
                                            <path
                                                d="M60.7795 1.42407H57.3495C57.2039 1.42407 57.0862 1.54289 57.0862 1.68877V19.1456C57.0862 19.2921 57.2039 19.4103 57.3495 19.4103H60.7795C60.9251 19.4103 61.0428 19.2915 61.0428 19.1456V1.68943C61.0428 1.54289 60.9251 1.42407 60.7795 1.42407Z"></path>
                                            <path
                                            ...
                                            <path
                                                d="M39.9663 6.16595H36.5614C36.4158 6.16595 36.2981 6.28477 36.2981 6.43065V19.146C36.2981 19.2926 36.4158 19.4107 36.5614 19.4107H39.9663C40.1119 19.4107 40.2296 19.2919 40.2296 19.146V6.43065C40.2296 6.28477 40.1119 6.16595 39.9663 6.16595Z"></path>
                                            <path
                    ...
                    <div class="TopNavigation-menuItems">
                            ...
                            <span class="sghi5jd">
                                <a
                                    ...
                                    @class([
                                        ...
                                        'r1k7ho1y',
                                        'etur5fu',
                                        's13oqxd2' => Route::is('home')
                                    ])
                                    href="{{route('home')}}"><span class="NavigationTab--span">Trang chủ</span>
                                </a>
                            </span>
                            <span class="sghi5jd">
                                <a
                                    @class([
                                        ...
                                        'r1k7ho1y',
                                        'etur5fu',
                                        's13oqxd2' => Route::is('quizlet.*')
                                    ])
                                    href="{{route('quizlet.home')}}">
                                    <span class="NavigationTab--span">Quizlet</span>
                                </a>
                            </span>
                        </div>
                    ...
                    <div class="TopNavigationItem RightNavigationItem">
                        <div data-overlay-container="true">
                            <button type="button" aria-haspopup="true" aria-expanded="false"
                                    id="react-aria1667614762-26" aria-label="Tạo"
                                    class="AssemblyButtonBase AssemblyIconButton AssemblyIconButton--primary AssemblyIconButton--circle AssemblyButtonBase--medium AssemblyButtonBase--circle"
                                    title="Tạo"
                                    onclick="changeStatusMenu('menu-create-header')"
                            >
                                <i class="fa-solid fa-plus fa-xl" style="line-height: 40px;"></i>
                            </button>
                        </div>
                    </div>
                    <div class="SiteAvatar TopNavigationItem RightNavigationItem">
                        <div data-overlay-container="true">
                            <div type="button" tabindex="0" id="react-aria1667614762-28" aria-haspopup="true"
                                 aria-expanded="false" aria-label="Cài đặt" role="button">
                                <img alt="Ảnh hồ sơ"
                                     class="AssemblyAvatar"
                                     src="https://graph.facebook.com/1328472667524768/picture?type=large"
                                     style="background-image: url('https://graph.facebook.com/1328472667524768/picture?type=large'); height: 40px; width: 40px;">
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="menu-create-header" style="display:none">
    <div style="position: absolute; z-index: 1099; left: 1630px; top: 55px; max-height: 940px;">
        <div
            style="border: 0; clip: rect(0px, 0px, 0px, 0px); clip-path: inset(50%); height: 1px; margin: 0px -1px -1px 0px; overflow: hidden; padding: 0px; position: absolute; width: 1px; white-space: nowrap;">
            <button id="react-aria5948858763-428" aria-label="Dismiss" tabindex="-1"></button>
        </div>
        <div class="poy4xqf">
            <div aria-label="Tạo" role="menu" tabindex="-1" id="react-aria5948858763-27"
                 aria-labelledby="react-aria5948858763-26" class="n1xoao7y m1pxhqs7">
                <div class="s1ovpdog">
                    <button aria-disabled="false" role="menuitem" tabindex="0" data-key="Lớp" class="r1ep6ugx r1k7ho1y">
                        <div class="c1ap9d88"
                             style="--c1ap9d88-1:0; --c1ap9d88-3:0 1.5rem; --c1ap9d88-6:2.5rem;">
                            <div class="iiekfr8" style="--iiekfr8-3: inherit;">
                                <div class="i1q3l8tw">
                                    <svg aria-label="class" class="AssemblyIcon AssemblyIcon--medium"
                                         role="presentation">
                                        <noscript></noscript>
                                        <use xlink:href="#class"></use>
                                        <noscript></noscript>
                                    </svg>
                                    <span class="AssemblyMenuItem--title t1nsp0j0">Lớp</span>
                                </div>
                            </div>
                        </div>
                    </button>
                    <button aria-disabled="false" role="menuitem" tabindex="-1" data-key="Học phần"
                            class="r1ep6ugx r1k7ho1y">
                        <div class="c1ap9d88"
                             style="--c1ap9d88-1:0; --c1ap9d88-3:0 1.5rem; --c1ap9d88-6:2.5rem; ">
                            <div class="iiekfr8" style="--iiekfr8-3: inherit;">
                                <div class="i1q3l8tw">
                                    <svg aria-label="sets" class="AssemblyIcon AssemblyIcon--medium"
                                         role="presentation">
                                        <noscript></noscript>
                                        <use xlink:href="#sets"></use>
                                        <noscript></noscript>
                                    </svg>
                                    <span class="AssemblyMenuItem--title t1nsp0j0">Học phần</span>
                                </div>
                            </div>
                        </div>
                    </button>
        ...
        <div
            style="border: 0; clip: rect(0px, 0px, 0px, 0px); clip-path: inset(50%); height: 1px; margin: 0px -1px -1px 0px; overflow: hidden; padding: 0px; position: absolute; width: 1px; white-space: nowrap;">
            <button id="react-aria5948858763-438" aria-label="Dismiss" tabindex="-1"></button>
        </div>
    </div>
    <span data-focus-scope-end="true" hidden=""></span>
</div>
<script type="text/javascript">
    function changeStatusMenu(id) {
